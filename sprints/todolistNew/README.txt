La aplicación es una todo list.
para ejecutar el proyexto hay que copiarse el repositorio y bajarselo, tener nodejs instalado en el ordenador.
...
el archivo para ejecutar la app en la consola es appCLI.ts compilado automaticamente a appCLI.js
